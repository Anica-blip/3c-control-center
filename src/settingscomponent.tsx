...
function SettingsComponent() {
  ...
  // Telegram Channels/Groups State - EMPTY to start  
  ...
  const addCharacter = () => {
    ...
    const character = {
      ...
      image: newCharacter.image.trim() || null,
      created_at: new Date().toISOString()
    };
    setCharacters(prev => [...prev, character]);
    setNewCharacter({ name: '', username: '', title: '', bio: '', image: '' });
    // TODO: Save to Supabase
    ...
    <div style={{ padding: '20px' }}>
      ...
      <div style={{ 
        ...
        <button
          ...
          style={{
            padding: '12px 20px',
            backgroundColor: activeTab === 'telegram' ? '#f3f4f6' : 'transparent',
            color: activeTab === 'telegram' ? '#1f2937' : '#6b7280',
            border: 'none',
            borderBottom: activeTab === 'telegram' ? '2px solid #3b82f6' : '2px solid transparent',
            ...
            <div style={{ display: 'grid', gap: '15px' }}>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="https://example.com/profile-image.jpg (or leave empty for default)"
                  style={{
                    width: '100%',
                    padding: '12px',
                    border: '1px solid #c4b5fd',
                ...
                <p style={{ margin: '8px 0 0 0', fontSize: '12px', color: '#6b7280' }}>
                  Enter image URL or leave empty for auto-generated avatar
                </p>
              </div>
